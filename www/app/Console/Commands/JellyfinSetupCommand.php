...
class JellyfinSetupCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Command to setup Jellyfin for Castoro';
    ...
    public function handle()
    {
        ...
        $api->updateConfiguration([
            'ServerName' => "Castoro #".crc32(env('HOSTNAME')),
        ...
        $api->updateBranding([
            'CustomCss' => "",
            'LoginDisclaimer' => "Welcome to Castoro! This service is open source, we take no responsibility for the use of this software, all misuse is at the user's discretion.",
        ...
        system("chown -R ".env('USER_NAME').":".env('USER_NAME')." ".cstr_data_path('/jellyfin'), $result);
        system("chown -R ".env('USER_NAME').":".env('USER_NAME')." ".cstr_data_path('/library'), $result);
