...
class DeleteImagesCommand extends Command
{
    ...
    protected $description = 'Command to delete Castoro images';
    ...
    public function handle()
    {
        ...
        try {
            ...
            system("rm -rf " . escapeshellarg(cstr_data_path('app/images')));
            //Re-create images folder
            if (!file_exists(cstr_data_path('app/images')))
                mkdir(cstr_data_path('app/images'), 0777, true);
            //Set permissions
            system("chown -R " . env('USER_NAME') . ":" . env('USER_NAME') . " " . escapeshellarg(cstr_data_path('app/images')));
